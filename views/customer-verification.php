...
require_once('../src/models/customer-sign-up.model.php');
...
<div class="video-container">
    ...
    <header class="nav-bar-primary" class="ui fixed top sticky">
        ...
        <div class="ui green top left attached label">Registration Form</div>
            ...
            <div class="">
            <legend style="font-size: 12px; font-weight:500;">GWSC Vistor Details</legend>
             ...
             <br>
             <legend style="font-size: 12px; font-weight:500;">Security Generate</legend>
             ...
             <p class="passmessagemismatch ui inverted segment" id="passwordMismatch">Passwords do not match.</p>
             <p class="passmessagematch ui inverted segment" id="passwordmatch">Passwords match.</p>   
                <script>
            ...
            <div class="ui blue bottom left attached label">Continue Registration Form</div>
            ...
            <button>
                    ...
                    <script>
                        ...
                        loginButton.addEventListener("click", () => {
                            ...
                            window.location.href = "./customer-login.php"; // Replace with the actual URL of your page
                        });
                    </script>
            <!-- Go to homepage -->
                    </button>
